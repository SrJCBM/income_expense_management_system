...
/**
 * Build script para empaquetar frontend + backend en distribución
...
const distResourcesBackend = path.resolve(frontendRoot, 'dist', 'resources', 'backend');
...
try {
  ...
  execSync('npm run build:frontend', { cwd: frontendRoot, stdio: 'inherit' });
  console.log('✅ [1/4] Frontend compilado\n');
  ...
  execSync('electron-builder --win', { cwd: frontendRoot, stdio: 'inherit' });
